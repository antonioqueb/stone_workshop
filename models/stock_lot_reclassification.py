...
class StockLotReclassification(models.Model):
    ...
    def _prune_ghost_line_commands(self, vals):
        ...
        if dropped:
            _logger.warning(
                ...
                '(sin lote o con id virtual) al guardar.', '[RECLASIFICACION]', dropped,
            )
    ...
    def _assert_lines_applicable(self):
        ...
        # (reacomodo de ubicación): no debe impedir reclasificar. Se libera
        # antes de validar (helper de inventory_shopping_cart; hasattr por
