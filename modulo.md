                        ...
                        <t t-foreach="state.recentOrders" t-as="order" t-key="order.id">
                            <div class="sw-order-row" t-on-click="() => this.openOrder(order.id)">
                                ...
                                <div class="sw-order-meta">
                                    ...
                                    <span><t t-esc="order.area_in_total.toFixed ? order.area_in_total.toFixed(2) : order.area_in_total"/> m²</span>
                                </div>
            ...
            <form string="Orden de Taller de Piedra">
                ...
                <sheet>
                    ...
                    <div class="alert alert-warning" role="alert" invisible="operation_mode != 'slab_cut'">
                        Corte de placas: captura manualmente en Salidas todos los formatos, retazos y merma por cada placa. El área total debe cuadrar contra la entrada.
                    </div>
                    <div class="alert alert-info" role="alert" invisible="operation_mode != 'format_process'">
                        Formatos / pallets: el proceso puede manejarse de forma agregada por cantidad.
                    </div>
                        ...
                        <page string="Resumen y costos">
                            <group string="Totales operativos">
                                ...
                                <group>
                                    ...
                                    <field name="area_tolerance_percent"/>
                                </group>
                            </group>
                            <group string="Costos">
                                <group>
